...
<head>
    ...
    <link rel="stylesheet" href="/pamStory/css/user/register.css"/>
    <style>
	    header {
	        width: 980px;
	        height: 142px;
...
<script src="/pamStory/js/daumPostcode.js"></script>
<script src="/pamStory/js/validation.js"></script>
<main id="user">
        <section class="register">
            <form action="/pamStory/user/register.do" name="formRegister" id="formRegister" method="post">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <button type="button" id="btnCheckUid">
                                    <img src="/pamStory/images/user/chk_id.gif" alt="중복확인">
                                </button>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <button type="button" id="btnSendEmail">
                                    <img src="/pamStory/images/user/chk_auth.gif" alt="인증번호 받기">
                                </button>
                                <span class="emailResult"></span>
                                <div class="auth">
                                    <input type="text" name="auth" placeholder="인증번호 입력">
                                    <button type="button" id="btnAuthEmail">
                                        <img src="/pamStory/images/user/chk_confirm.gif" alt="확인">
                                    </button>
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <button type="button" onclick="daumPostcode()">
                                    <img src="/pamStory/images/user/chk_post.gif" alt="우편번호찾기">
                                </button>
                ...
                <div>
                    <a href="/Pam/view/user/login.html" class="btn btnCancel">취소</a>
