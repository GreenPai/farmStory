...
<section class="right_section">
                ...
                <article>
                    ...
                    <p class="m-10">상품현황 <span><a href="/farmStory/admin/product_list.do">+더보기</a></span></p>
                ...
                <article>
                    <p class="m-10">
                        주문현황<span><a href="/farmStory/admin/order_list.do">+더보기</a></span>
                    </p>
                    <table class="order">
                        <thead>
                            <tr>
                ...
                <article>                  
                    <p class="m-10">회원현황<span><a href="/farmStory/admin/user_list.do">+더보기</a></span></p>
                    <table class="client">
                        <thead>
                            <tr>
                                <th>회원아이디</th>
