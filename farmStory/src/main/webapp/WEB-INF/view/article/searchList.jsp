...
<%@ include file="../layout/_header_bg.jsp" %>
        ...
        <section class="right_section">
            <article>
                ...
                <div>
                  <nav>
                    <h1><a href="/farmStory/article/list.do" style="position: absolute; ">글목록 전체</a> </h1>
                    <form action="/farmStory/article/search.do">
                        ...
                        <input type="text" name="keyword" value="${keyword}" placeholder="제목 키워드, 글쓴이 검색" style="width: 200px;">
