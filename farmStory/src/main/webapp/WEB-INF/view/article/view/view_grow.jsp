		...
		<article>
			<div>
				<div class="sub_nav_tit">
					<img src="/farmStory/images/sub_nav_tit_cate3_tit2.png"
						alt="텃밭가꾸기">
				</div>
				<div>
					<p class="intro">
						<img src="/farmStory/images/sub_page_nav_ico.gif" alt="텃밭가꾸기">
						HOME > 커뮤니티 > <span class="eco_txt">텃밭가꾸기&nbsp </span>
					</p>
				</div>
			</div>
